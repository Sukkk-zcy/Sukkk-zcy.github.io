import{g as U,s as q,a as V,b as Z,q as j,p as H,_ as s,l as w,c as J,E as K,I as Q,L as X,d as Y,y as ee,F as te}from"./mermaid.core.CewdoEAD.js";import{p as ae}from"./chunk-4BX2VUAB.COzQRWje.js";import{p as re}from"./treemap-KMMF4GRG.D24hy8H9.js";import"./transform.C0v2qCWc.js";import{d as G}from"./arc.C1cHgp2N.js";import{o as ie}from"./ordinal.C7BIYaFp.js";import{d as se}from"./pie.hH4qr9y4.js";var oe=te.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,le=structuredClone(oe),ne=s(()=>structuredClone(le),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,ee()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:H,getDiagramTitle:j,setAccTitle:Z,getAccTitle:V,setAccDescription:q,getAccDescription:U,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{ae(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),me={parse:s(async e=>{const a=await re("pie",e);w.debug(a),fe(a,W)},"parse")},he=s(e=>`
  .pieCircle{
