...
1. P4 Language Consortium. *P4-16 Language Specification v1.2.5*（类型 §7、语句 §11、架构 §12、Parser §13）. https://p4.org/p4-specs/
2. p4lang. *v1model.p4*. https://github.com/p4lang/p4c/blob/main/p4include/v1model.p4
3. p4lang. *p4c*. https://github.com/p4lang/p4c
4. p4lang. *P4 Tutorials*. https://github.com/p4lang/tutorials
5. 张恒华. *P4 中文教程*. https://github.com/zhh2001/p4-language-guide-zh
